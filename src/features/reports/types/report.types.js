...
export const REPORT_TYPE_LABELS = {
  ...
  [REPORT_TYPES.PROFIT_LOSS]: 'Profit & Loss Analysis',
  [REPORT_TYPES.PRODUCTS]: 'Product Performance',
  [REPORT_TYPES.TOP_SELLING]: 'Top-Selling Products',
  [REPORT_TYPES.SLOW_MOVING]: 'Slow-Moving & Dead Stock',
  [REPORT_TYPES.CUSTOMERS]: 'Customer Report',
  [REPORT_TYPES.CUSTOMER_ANALYTICS]: 'Customer Analytics & Trends',
  [REPORT_TYPES.STAFF]: 'Staff Performance',
  [REPORT_TYPES.EMPLOYEE_PERFORMANCE]: 'Employee Performance Details',
  [REPORT_TYPES.PAYMENTS]: 'Payment Report',
  [REPORT_TYPES.PAYMENT_ANALYSIS]: 'Payment Method Analysis',
  [REPORT_TYPES.BOOKINGS]: 'Booking Report',
  [REPORT_TYPES.INVENTORY]: 'Inventory Report',
  [REPORT_TYPES.INVENTORY_VALUATION]: 'Inventory Valuation',
  [REPORT_TYPES.TAX]: 'Tax Report',
  [REPORT_TYPES.BRANCH]: 'Branch Performance',
};

export const REPORT_TYPE_DESCRIPTIONS = {
  [REPORT_TYPES.SALES]: 'Comprehensive sales analysis with daily, weekly, and monthly breakdowns',
  [REPORT_TYPES.REVENUE]: 'Revenue breakdown by period, branch, and category',
  [REPORT_TYPES.PROFIT_LOSS]: 'Complete profit and loss statement with income and expenses',
  [REPORT_TYPES.PRODUCTS]: 'Product sales performance and inventory metrics',
  [REPORT_TYPES.TOP_SELLING]: 'Analysis of best-performing products and categories',
  [REPORT_TYPES.SLOW_MOVING]: 'Identification of slow-moving and dead stock items',
  [REPORT_TYPES.CUSTOMERS]: 'Customer activity, retention, and lifetime value',
  [REPORT_TYPES.CUSTOMER_ANALYTICS]: 'Deep dive into customer behavior, segments, and trends',
  [REPORT_TYPES.STAFF]: 'Staff performance, attendance, and productivity',
  [REPORT_TYPES.EMPLOYEE_PERFORMANCE]: 'Detailed employee performance metrics and KPIs',
  [REPORT_TYPES.PAYMENTS]: 'Payment methods, transactions, and reconciliation',
  [REPORT_TYPES.PAYMENT_ANALYSIS]: 'Comprehensive payment method distribution and analysis',
  ...
  [REPORT_TYPES.INVENTORY_VALUATION]: 'Complete inventory valuation by category and location',
  [REPORT_TYPES.TAX]: 'Tax collected, remitted, and outstanding by jurisdiction',
